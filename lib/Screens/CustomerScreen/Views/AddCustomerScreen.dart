...
void _loadCustomerData() {
  ...
  Widget _buildPlanAndSubscriptionCard(bool formReady) {
    ...
    final validPlan = plans.any((p) => p.id == selectedMealPlan);
    final selectedPlanValue = validPlan ? selectedMealPlan : null;

    final validPartner = partners.any((p) => p.deliveryPartnerProfile!.id == selectedPartner);
    final selectedPartnerValue = validPartner ? selectedPartner : null;
          ...
          plans.isEmpty
              ...
              : DropdownButtonFormField<String>(
                  ...
                  items: plans
                      ...
                      .toList(),
                  onChanged: formReady ? (val) => setState(() => selectedMealPlan = val) : null,
          ...
          partners.isEmpty
              ...
              : DropdownButtonFormField<String>(
                  ...
                  items: partners
                      ...
                      .toList(),
                  onChanged: formReady ? (val) => setState(() => selectedPartner = val) : null,
