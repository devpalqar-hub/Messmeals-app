...
Padding(
  ...
  child: DropdownButtonHideUnderline(
          ...
          authCtrl.update();
                                  ...
                                  Expanded(
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            "Enter your phone number",hintStyle: TextStyle(fontSize: 12.sp),
                                        prefixIcon: Icon(
                            ...
                            InkWell(
                              onTap: authCtrl.isLoading
                                  ...
                                  : () async {
                                      String phone =
                                      authCtrl.phoneController.text.trim();
   // "${authCtrl.countryCode}${authCtrl.phoneController.text.trim()}";
                                      ...
                                      bool success =
                                          await authCtrl.sendOtp(phone);

                                      if (success) {
                                       Get.to(
  () => OtpVerificationScreen(
  phoneNumber: authCtrl.phoneController.text.trim(),
  ),
);
                                      }
                                    },
